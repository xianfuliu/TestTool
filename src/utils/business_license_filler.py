    ...
    def fill_business_license(self, business_data):
        ...
        try:
            ...
            try:
                # 1. 统一社会信用代码
                draw.text(
                    positions["unified_social_credit_code"],
                ...
                # 5. 法定代表人
                draw.text(
                    positions["legal_representative"],
                ...
                draw.text(
                    positions["establishment_year"], year, fill="black", font=main_font
                )
                draw.text(
                    positions["establishment_month"],
                    month,
                    fill="black",
                    font=main_font,
                )
                draw.text(
                    positions["establishment_day"], day, fill="black", font=main_font
                )
                ...
                if business_term == "长期":
                    # 如果是长期，在开始日期位置显示"长期"
                    draw.text(
                        positions["business_term_start_year"],
                        "长期",
                        fill="black",
                        font=main_font,
                    )
                    ...
                    if len(start_end) == 2:
                        ...
                        draw.text(
                            positions["business_term_start_month"],
                            start_month,
                            fill="black",
                            font=main_font,
                        )
                        draw.text(
                            positions["business_term_start_day"],
                            start_day,
                            fill="black",
                            font=main_font,
                        )
                        draw.text(
                            positions["business_term_end_year"],
                            end_year,
                            fill="black",
                            font=main_font,
                        )
                        draw.text(
                            positions["business_term_end_month"],
                            end_month,
                            fill="black",
                            font=main_font,
                        )
                        draw.text(
                            positions["business_term_end_day"],
                            end_day,
                            fill="black",
                            font=main_font,
                        )
                ...
                scope_lines = self._split_text_by_width(
                    scope, scope_font, max_width=600
                )  # 缩小宽度到600像素
                scope_y = positions["business_scope"][1]

                for line in scope_lines:
                    draw.text(
                        (positions["business_scope"][0], scope_y),
                        line,
                        fill="black",
                        font=scope_font,
                    )
                ...
                if "registration_date" in business_data:
                    ...
                    draw.text(
                        positions["registration_year"],
                        reg_year,
                        fill="black",
                        font=main_font,
                    )
                    draw.text(
                        positions["registration_month"],
                        reg_month,
                        fill="black",
                        font=main_font,
                    )
                    draw.text(
                        positions["registration_day"],
                        reg_day,
                        fill="black",
                        font=main_font,
                    )
