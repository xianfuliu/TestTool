...
class VariableManager:
    ...
    def replace_variables(
        self, text: str, additional_vars: Dict[str, Any] = None
    ) -> str:
        """替换文本中的变量"""
    ...
    def _replace_variables_single_pass(
    ...
    def replace_variables_in_dict(
        self, data: Dict[str, Any], additional_vars: Dict[str, Any] = None
    ) -> Dict[str, Any]:
        """替换字典中的变量"""
    ...
    def replace_variables_in_list(
        self, data: List[Any], additional_vars: Dict[str, Any] = None
    ) -> List[Any]:
        """替换列表中的变量"""
...
class VariableParser:
    ...
    def parse_variable_expression(expression: str) -> Dict[str, Any]:
        ...
        # 无法解析
        return {"type": "unknown", "raw": expression}
...
if __name__ == "__main__":
    ...
    vm.set_local_variables({"token": "temp_token_abc", "page": 1})
