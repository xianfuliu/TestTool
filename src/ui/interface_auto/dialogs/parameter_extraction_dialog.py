...
class ParameterExtractionDialog(QDialog):
    ...
    def add_extraction_row(self, insert_after_row=None):
        ...
        add_button.clicked.connect(
            lambda checked, row=row_data: self.add_extraction_row(row)
        )
    ...
    def save_extraction_data(self):
        ...
        for row_data in self.extraction_rows:
            ...
            if variable_name or json_path:
                extractions.append(
                    {"variable_name": variable_name, "json_path": json_path}
                )
    ...
    def on_save(self):
        ...
        extraction_config = {
            ...
            "config": {"name": name, "enabled": True, "extractions": extraction_data},
        }
